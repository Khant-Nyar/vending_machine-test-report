        ...
        <div class="flex h-16 items-center justify-between">
            <div class="flex items-center">
                <div class="flex-shrink-0">
                    <img class="h-8 w-8" src="/images/logo.png" alt="Vendor machine">
                </div>
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="/products"
                            class="<?= urlIs('/products') ? 'bg-gray-900 text-white' : 'text-gray-300' ?> hover:bg-gray-700 px-3 py-2 rounded-md text-sm font-medium">Home</a>
                    </div>
                </div>
            </div>
            <div class="hidden md:block">
                    ...
                    <div class="relative ml-3">
                        <button type="button"
                            ...
                            <p class="text-white">
                                ...
                                Your role is: <?= htmlspecialchars($_SESSION['user']['role']) ?>
                                <?php endif; ?>
                            </p>
